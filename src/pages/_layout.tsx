...
export default async function RootLayout({ children }: RootLayoutProps) {
  return (
    <>
      ...
      <meta name="description" content="GitHub Pull Requests collection by sasagar" />
      ...
      <meta property="og:description" content="GitHub Pull Requests collection by sasagar" />
      ...
      <meta name="twitter:description" content="GitHub Pull Requests collection by sasagar" />
